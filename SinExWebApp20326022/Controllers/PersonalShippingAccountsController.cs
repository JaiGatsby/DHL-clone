...
namespace SinExWebApp20326022.Controllers
{
    public class PersonalShippingAccountsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShippingAccountId,Building,Street,City,Province,PostalCode,PhoneNumber,EmailAddress,FirstName,LastName,CreditCardType,CreditCardNumber,CreditCardSecurityNumber,CreditCardCardholderName,CreditCardExpiryMonth,CreditCardExpiryYear")] PersonalShippingAccount personalShippingAccount)
        {
        ...
        //{
        //    PersonalShippingAccount personalShippingAccount = db.ShippingAccounts.Find(id);
